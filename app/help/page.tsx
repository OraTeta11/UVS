    ...
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Click on the 'Forgot Password' link on the login page. You'll receive a password reset link at your registered email address. For security, you'll need to complete facial verification again when setting a new password.",
        },
      ],
    },
    {
